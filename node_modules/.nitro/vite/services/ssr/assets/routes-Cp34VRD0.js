import { n as LogoWordmark, t as LogoMark } from "./Logo-AGteKSHq.js";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Database, Layers, LineChart, ShieldCheck, TrendingUp, Zap } from "lucide-react";
//#region src/assets/hero-finverse.jpg
var hero_finverse_default = "/assets/hero-finverse-B07Iu0Dk.jpg";
//#endregion
//#region src/assets/icon-brain.jpg
var icon_brain_default = "/assets/icon-brain-CxNndRYx.jpg";
//#endregion
//#region src/assets/icon-shield.jpg
var icon_shield_default = "/assets/icon-shield-5tQgT_8p.jpg";
//#endregion
//#region src/assets/icon-chart.jpg
...
function Hero() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 grid-bg opacity-40 pointer-events-none" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary animate-pulse-glow" }), "Built for FINOVATE 2026 · Malawi"]
					}),
					/* @__PURE__ */ jsxs("h1", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Link, {
							...
							children: ["Launch the simulator", /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 group-hover:translate-x-1 transition" })]
						}), /* @__PURE__ */ jsx("a", {
							href: "#how",
				...
				className: "relative",
				children: [
					/* @__PURE__ */ jsx("div", { className: "absolute -inset-10 bg-gradient-to-br from-primary/20 via-transparent to-gold/20 blur-3xl" }),
					/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsx(FloatingCard, {
						...
						icon: /* @__PURE__ */ jsx(ShieldCheck, { className: "w-4 h-4 text-primary" }),
						label: "Confidence",
						value: "76%",
					...
					/* @__PURE__ */ jsx(FloatingCard, {
						...
						icon: /* @__PURE__ */ jsx(TrendingUp, { className: "w-4 h-4 text-gold" }),
						label: "Repayment",
						value: "APPROVE",
...
function Trust() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("span", { children: "Mobile Money" }),
				/* @__PURE__ */ jsx("span", {
					className: "opacity-40",
					children: "·"
				}),
				/* @__PURE__ */ jsx("span", { children: "Supplier Invoices" }),
				/* @__PURE__ */ jsx("span", {
					className: "opacity-40",
					children: "·"
				}),
				/* @__PURE__ */ jsx("span", { children: "Inventory Data" }),
				/* @__PURE__ */ jsx("span", {
					className: "opacity-40",
					children: "·"
				}),
				/* @__PURE__ */ jsx("span", { children: "Seasonality" }),
				/* @__PURE__ */ jsx("span", {
					className: "opacity-40",
					children: "·"
				}),
				/* @__PURE__ */ jsx("span", { children: "Monte Carlo" })
			]
		})
	});
}
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(SectionHeading, {
				...
				children: steps.map((s, i) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: s.n
								}), /* @__PURE__ */ jsx(s.icon, { className: "w-4 h-4 text-gold" })]
							}),
							/* @__PURE__ */ jsx("h4", {
					...
					}), i < steps.length - 1 && /* @__PURE__ */ jsx("div", { className: "hidden md:block absolute top-1/2 -right-2 w-4 h-px bg-gradient-to-r from-primary/60 to-transparent" })]
				}, s.n))
			})]
		})
	});
...
function Scenarios() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(SectionHeading, {
				eyebrow: "The output",
				title: /* @__PURE__ */ jsxs(Fragment, { children: ["Three futures. ", /* @__PURE__ */ jsx("span", {
					className: "gradient-text",
				...
				children: [
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: `absolute inset-x-0 top-0 h-1 ${c.color === "primary" ? "bg-gradient-to-r from-primary to-primary-glow" : c.color === "gold" ? "bg-gradient-to-r from-gold to-primary" : "bg-gradient-to-r from-destructive to-gold"}` }),
						/* @__PURE__ */ jsx("div", {
							className: "text-sm text-muted-foreground",
							children: c.name
						}),
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { children: "Probability of scenario" }), /* @__PURE__ */ jsxs("span", {
...
function CTA() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 hero-radial opacity-80 pointer-events-none" }), /* @__PURE__ */ jsxs("div", {
				className: "relative",
				children: [
					/* @__PURE__ */ jsxs("h2", {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							...
							children: ["Sign in to FINVERSE", /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4" })]
						})
					})
				]
			})]
	...
	return /* @__PURE__ */ jsx("footer", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(LogoMark, { className: "w-7 h-7" }),
					/* @__PURE__ */ jsxs("span", {
