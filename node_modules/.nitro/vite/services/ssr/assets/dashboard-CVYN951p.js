import { t as supabase } from "./client-CYzVOhP_.js";
import { n as useAuth } from "./use-auth-DLGuRDd_.js";
import { n as LogoWordmark } from "./Logo-AGteKSHq.js";
import { useEffect, useState } from "react";
import { useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AlertTriangle, ArrowRight, Building2, Calendar, CheckCircle2, Eye, Loader2, LogOut, Plus, Sparkles, Trash2, TrendingUp, XCircle } from "lucide-react";
...
function DashboardPage() {
	...
	if (loading || !user) return /* @__PURE__ */ jsx("div", {
		className: "min-h-screen grid place-items-center bg-background text-muted-foreground",
		children: /* @__PURE__ */ jsx(Loader2, { className: "w-6 h-6 animate-spin text-primary" })
	});
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("header", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(LogoWordmark, {}), /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: [/* @__PURE__ */ jsx(LogOut, { className: "w-3.5 h-3.5" }), " Sign out"]
					})]
				})]
			})
		}), /* @__PURE__ */ jsxs("main", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(NewProfileCard, { onCreated: () => window.dispatchEvent(new Event("finverse:refresh")) }), /* @__PURE__ */ jsx(PortfolioList, {})]
			})]
		})]
	});
}
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Building2, { className: "w-4 h-4 text-primary" }), /* @__PURE__ */ jsx("h2", {
			...
			/* @__PURE__ */ jsxs("form", {
				...
				children: [
					...
					err && /* @__PURE__ */ jsxs("div", {
						className: "text-xs text-destructive flex items-start gap-1.5",
						children: [
							/* @__PURE__ */ jsx(AlertTriangle, { className: "w-3.5 h-3.5 mt-0.5" }),
							" ",
							err
						]
					}),
					/* @__PURE__ */ jsxs("button", {
						...
						children: [busy ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsx(Plus, { className: "w-4 h-4" }), "Add MSME"]
					})
				]
			})
		]
...
function PortfolioList() {
	...
	if (loading) return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx(Loader2, { className: "w-5 h-5 animate-spin text-primary" })
	});
	if (items.length === 0) return /* @__PURE__ */ jsxs("div", {
		className: "glass-card rounded-2xl p-10 text-center",
		children: [
			/* @__PURE__ */ jsx(Sparkles, { className: "w-8 h-8 mx-auto text-primary mb-3" }),
			/* @__PURE__ */ jsx("h3", {
	...
	return /* @__PURE__ */ jsx("div", {
		className: "space-y-4",
		children: items.map((m) => /* @__PURE__ */ jsx(MsmeCard, {
			msme: m,
			sim: sims[m.id],
			onChange: load
		}, m.id))
...
function MsmeCard({ msme, sim, onChange }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							runwayMonths < 12 && /* @__PURE__ */ jsx("span", {
			...
			sim ? /* @__PURE__ */ jsx("div", {
				className: "mt-5",
				children: /* @__PURE__ */ jsxs("div", {
					className: "grid md:grid-cols-[180px_1fr_auto] gap-5 items-start",
					children: [
						/* @__PURE__ */ jsx(ScoreRing, { score: Number(sim.ffcs_score) }),
						/* @__PURE__ */ jsxs("div", {
							className: "space-y-3",
							children: [
								/* @__PURE__ */ jsxs("div", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", {
										className: "mt-0.5",
										children: sim.recommendation?.startsWith("✅") ? /* @__PURE__ */ jsx(CheckCircle2, { className: "w-4 h-4 text-green-500" }) : sim.recommendation?.startsWith("❌") ? /* @__PURE__ */ jsx(XCircle, { className: "w-4 h-4 text-red-500" }) : /* @__PURE__ */ jsx(AlertTriangle, { className: "w-4 h-4 text-amber-500" })
									}), /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("button", {
					...
					children: running ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin" }), " Simulating 1,000 futures…"] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
						/* @__PURE__ */ jsx(TrendingUp, { className: "w-4 h-4" }),
						sim ? "Re-run simulation" : "Run simulation",
						/* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4" })
					] })
				}), sim && /* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-1.5 text-xs text-muted-foreground",
					children: [/* @__PURE__ */ jsx(Calendar, { className: "w-3.5 h-3.5" }), new Date(sim.created_at).toLocaleDateString()]
				})]
			})
		]
	});
